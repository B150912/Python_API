...
#dt = datetime(2022,1,21).date()
#dt_fim = datetime(2022,1,31).date()
...
tipo = "FLASH"
token = "eyJhbGciOiJIUzI1NiJ9.NWM0ODk1MGU2NzM2YzI0MjRhYWRkNGY1.Uxin2zEGBRw7oNH4fRRPgVVJ8LJZBccRCzM2uZGkizg"
